...
import NotifikasjonSystem.PrintNotifikasjoner;
 ...
 */
@WebServlet(name = "NotifikasjonsListe", urlPatterns = {"/NotifikasjonsListe"})
public class NotifikasjonsListe extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>SLIT - NotifikasjonsListe</title>");
